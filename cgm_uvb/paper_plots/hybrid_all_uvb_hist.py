...
def make_many_plots(den, met, outpath, ion_num = [8], uvb_true ='KS18', q_true = 18):
    ...
    add_num = 0.7
    ax1.set_xlim(np.log10(den)-add_num, np.log10(den)+add_num)
    ax1.set_ylim(met-add_num, met+add_num)
...
for n in Narray:
    for z in Zarray:
        make_many_plots(den=n, met=z, outpath= '/home/vikram/cloudy_run/more_fig/hybrid')