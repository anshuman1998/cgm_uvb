...
out_fig_name = 'scatter_den_photoionized_all_nions.pdf'
figure_size = [14, 4]
...
ax1.set_xlim(0.25, 1.2)
ax1.set_ylim(0.1, 0.95)
ax2.set_xlim(0.25, 1.22)
#ax2.set_ylim(-0.05, 0.95)
ax3.set_xlim(0.1, 0.94)
...
for ax in(ax1, ax2, ax3):
    ...
    if ax ==ax1:
        ax.annotate('Photoionized\n'+ 'absorber', xy=(0.65, 0.87),
