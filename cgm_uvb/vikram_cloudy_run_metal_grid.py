...
def run_parallel(logZ, uvb_Q, uvb):
    ...
    fname = (logZ+4)*100
    input_File = '/scratch/vikram/cloudy_run/metal_NH17/try_{}_Q{}_Z{:.0f}.in'.format(uvb, uvb_Q, fname)
...
path  = '/scratch/vikram/cloudy_run/metal_NH17'
...
pool = mp.Pool(processes=int(28*5))
